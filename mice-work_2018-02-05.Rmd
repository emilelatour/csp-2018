...
complete <- complete.cases(valdata)
sum(complete) / length(complete)
sum(!complete) / length(complete)

naniar::n_complete(valdata)
naniar::pct_complete(valdata)
naniar::miss_summary(valdata)
naniar::miss_case_pct(valdata)
naniar::miss_case_prop(valdata)  # ********
naniar::miss_case_table(valdata)

valdata %>% 
  dplyr::filter_if(is.na)


!complete.cases(valdata) %>% 
  janitor::tabyl(.)
```
